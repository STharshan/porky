  ...
  return (
    <footer className="bg-black text-gray-300 py-12 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://www.instagram.com/porkysgym/?hl=en" className="text-primary-hover transition">
              <FaInstagram />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center space-x-2">
              ...
              <span>+44 7715 358273</span>
            </li>
            <li className="flex items-center space-x-2">
              <FiMail className="text-primary " />
              <span>Teamdesfitness@gmail.com</span>
            </li>
      ...
      <div className="mt-10 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
        ...
        <span className="text-primary ">Porky's Gym</span> | Powered by{" "}
